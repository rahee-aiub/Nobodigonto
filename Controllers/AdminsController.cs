...
namespace TestCoreApp.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(NobodigontoDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Balance")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Balance")] Admin admin)
        {
            if (id != admin.Id)
            {
                return NotFound();
